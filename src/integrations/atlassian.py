...
class AtlassianThreatIntel:
    ...
    async def get_hunting_playbooks(self, space: str = "THREATHUNT") -> List[Dict]:
        ...
        try:
            ...
            logger.info(f"Retrieved {len(playbooks)} hunting playbooks from Confluence")
            return playbooks
    ...
    async def create_hunt_ticket(self, hunt: ThreatHunt, project_key: str = "HUNT") -> Optional[str]:
        ...
        try:
            ...
            logger.info(f"Created Jira ticket {hunt_ticket_key} for hunt {hunt.hunt_id}")
    ...
    async def create_detection_page(self, detection: Dict, space: str = "THREATHUNT") -> Optional[str]:
        ...
        try:
            ...
            new_page = self.confluence.create_page(
                ...
                title=page_title,
                body=page_content,
                labels=['detection-rule', 'automated']
            )
            
            page_url = f"{self.confluence.url}/wiki{new_page['_links']['webui']}"
...
"""
    ...
    def _get_hunt_custom_fields(self, hunt: ThreatHunt) -> Dict:
        ...
        # custom_fields['customfield_10002'] = hunt.maturity_level.value  # Maturity Level
